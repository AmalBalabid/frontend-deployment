...
export const register = (data, navegate) => {
  ...
  return (dispatch) => {
    ...
    axios
      .post("https://pharmacy-backend-test-dep.herokuapp.com/users/addPharmacy", data, {headers:{authorization:`Bearer ${token}`}})
      .then((res) => {
...
export const getPharmacy = (id, navegate , navegate2) => {
  ...
  return (dispatch) => {
    dispatch(Request());
    axios
    .get(`https://pharmacy-backend-test-dep.herokuapp.com/users/pharmacy/${id}`,{headers:{authorization:`Bearer ${token}`}})
    .then((res) => {
      const pharmacies = res.data;
...
export const searchMedicine = (SearchStr) => {
  ...
  return (dispatch) => {
    ...
    if (searchParams.length >= 3) {
      axios
        .get("https://pharmacy-backend-test-dep.herokuapp.com/medicines/search", {
          params: {
      ...
      axios
        .get("https://pharmacy-backend-test-dep.herokuapp.com/medicines/search2", {
          params: {
            first: searchParams[0],
            second: searchParams[1],
            third: searchParams[2],
      ...
      axios
        .get("https://pharmacy-backend-test-dep.herokuapp.com/medicines/search1", {
          params: {
            first: searchParams[0],
            second: searchParams[1],
            third: searchParams[2],
...
export const updatePharmacy = (id, data) => {
  ...
  return (dispatch) => {
    ...
    axios
      .put(`https://pharmacy-backend-test-dep.herokuapp.com/pharmacies/${id}`, data, {headers:{authorization:`Bearer ${token}`}})
      .then((res) => {
        const pharmacies = res.data;
        dispatch(Success(pharmacies));
        localStorage.setItem("pharmacy", JSON.stringify(pharmacies));
...
export const deletePharmacy = (id,navegate) => {
  ...
  return (dispatch) => {
    dispatch(Request());
    axios
      .delete(`https://pharmacy-backend-test-dep.herokuapp.com/pharmacies/${id}`, {headers:{authorization:`Bearer ${token}`}})
      .then((res) => {
        const pharmacies = res.data;
        dispatch(Success(pharmacies));
        localStorage.setItem("pharmacy", JSON.stringify(pharmacies));
