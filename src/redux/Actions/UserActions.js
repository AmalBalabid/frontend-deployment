...
export const getUser = (id) => {
  return (dispatch) => {
    dispatch(Request());
    axios
      .get(`https://pharmacy-backend-test-dep.herokuapp.com/users/${id}`)
      .then((response) => {
...
export const logIn = (username, password, navegate) => {
  ...
  return (dispatch) => {
    dispatch(Request());
    axios
      .post("https://pharmacy-backend-test-dep.herokuapp.com/login", user)
      .then((response) => {
...
export const signUp = (data, navegate) => {
  ...
  return (dispatch) => {
    ...
    dispatch(Request());
    axios
      .post("https://pharmacy-backend-test-dep.herokuapp.com/users", data)
      .then((response) => {
        const user = response.data;
...
export const updateUser = (id,data) => {
  ...
  return (dispatch) => {
    dispatch(Request());
    axios
      .put(`https://pharmacy-backend-test-dep.herokuapp.com/users/${id}`, data, {headers:{authorization:`Bearer ${token}`}})
      .then((res) => {
        const user = res.data;
        dispatch(Success(user));
